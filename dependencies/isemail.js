...
exports.validate = internals.validate = function (email, options, callback) {
        ...
        switch (token) {
          ...
          case '(':
            if (elementLength === 0) {
              ...
              updateResult(elementCount === 0 ? internals.diagnoses.cfwsComment
          ...
          case '.':
            if (elementLength === 0) {
              // Another dot, already?
              updateResult(elementCount === 0 ? internals.diagnoses.errDotStart
          ...
          case '\t':
            if (elementLength === 0) {
              updateResult(elementCount === 0 ? internals.diagnoses.cfwsFWS
  ...
  const finish = () => {
    ...
    const finishResult = diagnose ? maxResult
